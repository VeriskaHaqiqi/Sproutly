...
<head>
    ...
    <title>Consultation History - Sproutly Expert</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/style-consultexpert.css') }}">
</head>
<body>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-logo">
        <a href="{{ url('/expert/home') }}">
            <img src="{{ asset('images/logo-hijau.png') }}" alt="Sproutly Logo" class="sidebar-logo-img">
            <span class="sidebar-logo-text">Sproutly</span>
        </a>
    </div>
    <nav class="sidebar-nav">
        <a href="{{ url('/expert/dashboard') }}" class="sidebar-item">
            <img src="{{ asset('images/dashboard.png') }}" alt="Dashboard" class="sidebar-icon">
            <span>Dashboard</span>
        </a>
        <a href="{{ url('/expert/consultation') }}" class="sidebar-item">
            <img src="{{ asset('images/consultation.png') }}" alt="Consultation" class="sidebar-icon">
            <span>Consultation</span>
        </a>
        <a href="{{ url('/expert/client-history') }}" class="sidebar-item active">
            <img src="{{ asset('images/clienthistory.png') }}" alt="Client History" class="sidebar-icon">
            <span>Client History</span>
        </a>
        <a href="{{ url('/expert/article') }}" class="sidebar-item">
            <img src="{{ asset('images/myarticle.png') }}" alt="Article" class="sidebar-icon">
            <span>Article</span>
        </a>
        <a href="{{ url('/expert/reviews') }}" class="sidebar-item">
            <img src="{{ asset('images/reviews.png') }}" alt="Reviews" class="sidebar-icon">
            <span>Reviews</span>
        </a>
        <a href="{{ url('/expert/payment') }}" class="sidebar-item">
            <img src="{{ asset('images/payment.png') }}" alt="Payment" class="sidebar-icon">
            <span>Payment</span>
        </a>
        <a href="{{ url('/expert/settings') }}" class="sidebar-item">
...
<div class="main-wrapper">
    ...
    <header class="navbar">
        <div class="navbar-left">
            ...
            <a href="{{ url('/expert/home') }}" class="navbar-brand">
    ...
    <main class="content">
        ...
        <section class="hero-section">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">Track and manage your client consultations</p>
            </div>
        </section>
        ...
        <section class="filter-section">
            <div class="filter-container">
                ...
                <a href="{{ url('/expert/consultation') }}" class="btn-cta">
        ...
        <div class="footer-inner">
            ...
            <div class="footer-social">
                ...
                <div class="social-icons">
                    ...
                    <a href="#" class="social-icon"><img src="{{ asset('images/instagram.jpg') }}" alt="Instagram"></a>
                    <a href="#" class="social-icon"><img src="{{ asset('images/X.jpg') }}" alt="X"></a>
                </div>
            </div>
        </div>
...
<script src="{{ asset('js/script-consultexpert.js') }}"></script>
</body>
</html>